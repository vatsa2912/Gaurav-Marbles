        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/70 border border-slate-200/80 p-5 sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-xs text-slate-500 mt-1">
              Enter your credentials to access inventory, sales, and accounts.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@gauravmarbles.com"
                  required
                  autoComplete="email"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-xs font-semibold text-slate-600 hover:text-slate-900 transition underline underline-offset-2"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition bg-slate-50/50 hover:bg-white"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 px-4 bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold rounded-xl transition shadow-md shadow-slate-900/10 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
                <>
